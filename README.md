# Dostaevsky Site ERP Api OpenAPI Specification
[![Build Status](https://travis-ci.org/Sergeyii/dostaevsky-erp-api.svg?branch=master)](https://travis-ci.org/Sergeyii/dostaevsky-erp-api)
...
6. If you did everything correct, https://sergeyii.github.io/dostaevsky-erp-api/ will lead to your new docs
...
- Documentation(ReDoc): https://sergeyii.github.io/dostaevsky-erp-api/
- SwaggerUI: https://sergeyii.github.io/dostaevsky-erp-api/swagger-ui/
- Look full spec:
    + JSON https://sergeyii.github.io/dostaevsky-erp-api/swagger.json
    + YAML https://sergeyii.github.io/dostaevsky-erp-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://sergeyii.github.io/dostaevsky-erp-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://sergeyii.github.io/dostaevsky-erp-api/ with url from the message: `Server started <url>`
